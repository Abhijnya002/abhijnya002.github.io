  ...
  return (
    ...
    >
      <div className="navbar-container">
        ...
        >
          <b>Abhijnya Konanduru Gurumurthy</b>
        </motion.a>
        ...
        >
          ...
          >
            ...
            <motion.li
              className={
                activeLink === "education" ? "active nav-item" : "nav-item"
              }
              whileHover={screenWidth > 992 ? { scale: 1.1, rotate: -2 } : {}}
              whileTap={screenWidth > 992 ? { scale: 0.9, rotate: 2 } : {}}
            >
            ...
            {/* Feed tab removed - frontend-only mode */}
            <motion.li
              className="nav-item"
              whileHover={screenWidth > 992 ? { scale: 1.1, rotate: -2 } : {}}
              whileTap={screenWidth > 992 ? { scale: 0.9, rotate: 2 } : {}}
            ...
            >
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  addTab("AIChatTab", { title: "Abhijnya's AI Companion" });
                  setMenuOpen(false);
                }}
              >
                <span className="navbar-text">
