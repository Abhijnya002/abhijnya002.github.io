...
const Footer = ({ isBatterySavingOn, addTab }) => {
  const linksData = [
    {
      href: "https://github.com/Abhijnya002",
      icon: require("../../assets/img/icons/github.png"),
      label: "GitHub",
    },
    {
      href: "https://www.linkedin.com/in/abhijnyakg",
  ...
  return (
    ...
    >
      ...
      >
        <h2>Abhijnya Konanduru Gurumurthy</h2>
        <p>Where Data Meets Intelligence • Crafting Scalable AI/ML Systems</p>
      </motion.div>
      ...
      >
        <p>
          &copy; {new Date().getFullYear()} Abhijnya K.G. All rights reserved.
        </p>
      </motion.div>
    </motion.footer>
  );
