...
const tables = [
  ...
  { title: "Admin Management", key: "AbhijnyaPortfolio" },
...
const AdminConsole = ({ logout }) => {
  ...
  useEffect(() => {
    ...
    setAdminError("");
    if (selectedTable.key === "AbhijnyaPortfolio") {
    ...
    <div className="admin-console">
      <div className="admin-title-bar">
        ...
        <div className="admin-btn-group">
          <button
            ...
            onClick={() =>
              window.open(
                "https://cloud.mongodb.com/v2/672950dc517fd96235a1c212#/metrics/replicaSet/672951f5bf98b168a06dfdb4/explorer/AbhijnyaPortfolioDB",
                "_blank"
              )
            }
          >
      ...
      {!selectedTable ? (
        ...
        <div className="expanded-view">
          ...
          {selectedTable.key !== "AbhijnyaPortfolio" && (
            <span className="count">
