                ...
                >
                  <div className="slider-content">
                    ...
                    <div className="career-container">
                      <div className="career-image" style={{ backgroundColor: "#ffffff", borderRadius: "10px", overflow: "hidden" }}>
                        <img
                          src={experience.companyLogo || (experience.experienceImages && experience.experienceImages[0] ? experience.experienceImages[0] : `${process.env.PUBLIC_URL}/images/logos/default-company.png`)}
                          alt={experience.experienceCompany || "Company"}
