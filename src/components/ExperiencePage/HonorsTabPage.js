...
const HonorsTabPage = ({ addTab, isBatterySavingOn }) => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <h1 className="career-tab-header">My Achievements</h1>
                    ...
                    <div className="career-container">
                      <div className="career-image">
                        <img
                          src={
                            type === "honor"
                              ? (data.honorsExperienceImages && data.honorsExperienceImages[0] ? data.honorsExperienceImages[0] : `${process.env.PUBLIC_URL}/images/default-experience.webp`)
                              : (data.yearInReviewImages && data.yearInReviewImages[0] ? data.yearInReviewImages[0] : `${process.env.PUBLIC_URL}/images/default-experience.webp`)
                          }
                          alt=""
