...
const EducationPage = lazy(() => import("./components/EducationPage/EducationPage"));
...
function App({ isBatterySavingOn, setIsBatterySavingOn }) {
  ...
  const API_URL = ""; // Not used in frontend-only mode
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        {/* AI Chat button removed - frontend-only mode */}
        <Suspense fallback={null}>
          <WindowModal
            tabs={tabs}
            addTab={addTab}
