...
const Index = () => {
  ...
  company: "Syracuse University, Maxwell School of Citizenship and Public Affairs",
  location: "Syracuse, NY",
  period: "Sep 2025 – Present",
  logo: "/lovable-uploads/7dbca2d2-77d6-4c06-bd8c-24052363acfd.png",
  highlights: [
...
Where data meets intelligence • Crafting scalable AI/ML systems • Committed to accuracy and innovation              </p>
            </div>
...
>
  ...
  <a
    href="/Resume-Abhijnyakg.pdf"
    download="Abhijnya_Konanduru_Gurumurthy_Resume.pdf"
  >
    <Button
      variant="outline"
...
I’m a Data and Research Engineer pursuing my M.S. in Computer Science at Syracuse University, with experience at Mercedes-Benz Research and Development. I specialize in building scalable data pipelines, automating large-scale analytics workflows, and developing interactive dashboards using Python, SQL, and Power BI.
               </p>
                    <p className="text-lg text-white/80 leading-relaxed mb-6">
At Syracuse, I support data-driven policy research through automated API integrations and structured reporting pipelines. Previously at Mercedes-Benz, I optimized analytics systems that improved efficiency by 30% and achieved 99.9% data accuracy, combining technical precision with strategic impact.
        ...
        <div className="grid md:grid-cols-2 gap-8 justify-center">
          ...
          <Card className="bg-gradient-to-r from-[#4E1A7E] to-[#C7791B] border-yellow-400/60 backdrop-blur-md hover:from-[#C7791B]/70 hover:to-[#4E1A7E]/70 transition-all duration-300 hover-scale">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-yellow-100/90 text-base leading-relaxed">
                For driving customer-centric strategies and executing critical service enhancements
              </p>
            </CardContent>
          </Card>

          {/* AWS re:Invent Grant */}
          <Card className="bg-gradient-to-r from-[#FF9900] to-[#232F3E] border-orange-500/70 backdrop-blur-md hover:from-[#FFA41B]/80 hover:to-[#1E2A38]/80 transition-all duration-300 hover-scale">
            <CardContent className="p-8 text-center">
              <img
                src="https://its.uri.edu/wp-content/uploads/Amazon-AWS.jpg"
                alt="AWS Logo"
                className="w-28 h-20 mx-auto mb-4 rounded-lg shadow-md object-contain"
              />
              <p className="text-white font-bold text-xl mb-3">
                AWS re:Invent All Builders Welcome Grant 2025 
              </p>
              <p className="text-gray-100 text-base leading-relaxed">
  Honored to be selected for the <span className="font-semibold">AWS re:Invent All Builders Welcome Grant 2025</span>,
  recognizing builders who advance innovation, diversity, and technical excellence in the global cloud community.
</p>
...
<div>
  <h3 className="text-3xl font-bold text-center mb-10 text-blue-400">
    📜 Professional Certifications
  </h3>

  {/* Microsoft Power BI Certification */}
  <div className="flex justify-center mb-12">
    <Card className="bg-gradient-to-r from-[#0078D4] to-[#00A4EF] border-blue-400/60 backdrop-blur-md hover:from-[#00A4EF]/80 hover:to-[#0078D4]/80 transition-all duration-300 text-center hover-scale w-full md:w-2/3">
      <CardContent className="p-8">
        <img
        ...
        <p className="text-gray-100 text-base leading-relaxed">
          Successfully earned the <span className="font-semibold">Microsoft Certified: Power BI Data Analyst Associate</span> credential,
          demonstrating advanced proficiency in data modeling, visualization, and transforming business data into actionable insights.
        </p>
      </CardContent>
    </Card>
  </div>
  ...
  <div className="grid md:grid-cols-3 gap-8">
    {certifications.map((cert, index) => (
      <Card
        key={index}
        className="bg-gradient-to-r from-[#0D47A1] to-[#1976D2] border-blue-400/60 backdrop-blur-md hover:from-[#1976D2]/80 hover:to-[#0D47A1]/80 transition-all duration-300 text-center hover-scale"
      >
        <CardContent className="p-8">
